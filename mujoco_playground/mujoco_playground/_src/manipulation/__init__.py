...
from mujoco_playground._src.manipulation.yam import tiptop_cube as yam_tiptop_cube
...
_envs = {
    ...
    "YamTiptopCube": yam_tiptop_cube.TiptopCube,
}
...
_cfgs = {
    ...
    "YamTiptopCube": yam_tiptop_cube.default_config,
}
